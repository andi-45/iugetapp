// src/app/admin/courses/details/page.tsx
'use client'
...
import { ArrowLeft, Book, FileText, BarChart3, Layers, Edit, GraduationCap, Loader2 } from 'lucide-react';
        ...
        <div className="md:col-span-2 space-y-8">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Aperçu du document PDF principal du cours.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="bg-muted rounded-lg p-4 flex items-center justify-between">
                        <p className="font-mono text-sm break-all">{course.pdfUrl}</p>
                        <Button variant="secondary" size="sm" asChild><a href={course.pdfUrl} target="_blank" rel="noopener noreferrer">Ouvrir</a></Button>
                    </div>
                    <div className="mt-4 aspect-video bg-secondary rounded-lg flex items-center justify-center">
                        <p className="text-muted-foreground">(Aperçu du PDF non disponible dans la maquette)</p>
                    </div>
                </CardContent>
            </Card>
